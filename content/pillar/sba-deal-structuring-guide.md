# SBA Deal Structuring: From LOI to Closing
...
That balancing act — which Brian explored in detail on [The Year of Discipline](/the-year-of-discipline-lol-19) episode — is what "structure" means. It's not any single element in isolation. It's how the equity injection, the seller note, the DSCR, and the collateral position all work together to tell a story the lender can get behind. If you want the full picture of SBA 7(a) loan mechanics, our [Complete Guide to SBA 7(a) Loans](/complete-guide-sba-7a-loans) is the place to start.
...
For a broader look at what lenders evaluate in acquisition deals, check out our guide on [SBA Business Acquisition: What Lenders Really Expect](/sba-business-acquisition-what-lenders-really-expect).
...
| Seller Note Status | Counts as Equity? | Affects DSCR? | Minimum Standby Period |
|---|---|---|---|
| Full standby (no P&I payments) | Yes | No | 24 months (some lenders require life of loan) |
| Partial standby (interest-only) | Varies by lender | Partially | Typically 24 months |
| Not on standby (full payments) | No | Yes — counted as debt service | N/A |
| No seller note at all | N/A | N/A | N/A |

For a deeper exploration of seller financing in SBA transactions, our [Seller Notes Deep Dive episode](/seller-notes-deep-dive-lol-15) covers this extensively.
...
For more on creative financing structures that can help with equity, see our article on [100% Financing for Business Expansion](/100-financing-for-business-expansion).
...
| Scenario | Adjusted EBITDA | Annual Debt Service | DSCR | Lender Comfort |
|---|---|---|---|---|
| Strong deal | $650,000 | $500,000 | 1.30x | Comfortable — room for a dip |
| Adequate deal | $580,000 | $500,000 | 1.16x | Tight — needs strong borrower profile |
| Below threshold | $490,000 | $500,000 | 0.98x | Declined as structured |
| Restructured (lower price) | $580,000 | $440,000 | 1.32x | Back in comfortable range |
...
If a borrower ends up in a situation where the debt service becomes unmanageable post-closing, we cover the options in [What to Do If You Can't Pay Your Business Loan](/what-to-do-if-you-cant-pay-your-business-loan).
...
If you're looking to build the skills to identify and mitigate these problems before they kill a deal, our [SBA Loan Originator Training](/sba-loan-originator-training) program walks through real deal scenarios.
...
If you want to go deeper on the craft of deal structuring — the difference between a package that satisfies the SOP and one that tells a story the credit committee can get behind — read [The Art of SBA Deal Structuring](/art-of-sba-deal-structuring). It covers LOI strategy, DSCR stress testing, and knowing when to walk away.

Financial analysis is where most originators either earn their keep or lose their credibility. Our guide on [how to read borrower financials like a pro](/how-to-read-borrower-financials) covers the 5 C's framework, cash flow analysis, and the red flags that blow up deals in underwriting.

The eight failure points that kill SBA deals over and over are documented in [Why Most SBA Deals Fall Apart](/why-sba-deals-fall-apart). If you can spot these patterns early, you save months of work on transactions that were never going to close.

For the equity injection argument straight from someone who spent decades processing liquidation packages, [Episode 20: Why Equity (Not Cash Flow) Makes or Breaks SBA Deals](/why-equity-not-cash-flow-makes-or-breaks-sba-deals-lol-20) features a former SBA deputy director of liquidations who has seen what happens when thin deals go sideways.

And if you want to hear what the boomer retirement wave looks like from the acquisition side — and why the window for buying cash-flowing businesses is wide open right now — [Episode 5: Broke or Billionaire by 2030](/broke-or-billionaire-by-2030-lol-5) is the episode that lays it out with real numbers.
