# Building an SBA Brokerage: From Solo to Scale

**Author:** Shane
**Word Count:** ~1,500
**Keywords:** SBA brokerage business, scale SBA lending
...
- You're still learning how to [structure deals](/sba-deal-structuring-guide) that survive credit committee
...
## Legal Structure — Getting the Foundation Right
...
With three well-chosen partners, you can place 90% of the deals that come across your desk. Add more as your volume justifies it. For a deeper look at how to [become an SBA loan broker](/how-to-become-sba-loan-broker) and build these relationships from scratch, the full career guide covers it.
...
Before you scale, make sure your pipeline is producing enough volume to justify hiring. Our guide on [how to build a $10M SBA pipeline in 12 months](/build-10m-sba-pipeline) covers the month-by-month action plan that most scaling brokerages run before they start adding headcount.
