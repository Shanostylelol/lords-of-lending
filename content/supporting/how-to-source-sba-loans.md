---
title: "How to Source SBA Loans: 12 Strategies for Finding Deals"
slug: how-to-source-sba-loans
date: 2026-03-10
description: "The real deal-sourcing playbook for SBA loan originators and brokers — 12 proven channels for finding qualified borrowers, from CPA referrals to trade associations to BizBuySell outreach."
image: supporting/how-to-source-sba-loans-hero.webp
category: supporting
author: shane
cluster: originator-training
keywords: ["SBA deal sourcing", "how to find SBA loans", "SBA loan lead generation", "SBA broker deal flow", "finding SBA borrowers"]
readingTime: 12
relatedSlugs: ["how-to-become-sba-loan-broker", "sba-loan-originator-training", "building-sba-lending-pipeline"]
---
...
If you're still deciding whether SBA origination is the right career path, start with our [How to Become an SBA Loan Broker](/how-to-become-sba-loan-broker) guide. It covers the full picture of what this career looks like. But if you already know this is what you want to do and you're ready to start filling your pipeline, keep reading.
...
1. **Pick three channels** from this list that match your existing strengths and network
2. **Commit 90 days** to working them consistently — weekly outreach, monthly check-ins, constant follow-up
3. **Track everything** — where deals come from, conversion rates, time from referral to close
4. **Add one new channel** every quarter once you've got the first three producing

If you want the full pipeline-building system — the CRM setup, the follow-up cadences, the templates, the qualification framework — read our guide on [Building an SBA Lending Pipeline](/building-sba-lending-pipeline). It picks up right where this article leaves off.

And if you're ready to go deeper into the mechanics of SBA origination, our [SBA Loan Originator Training](/sba-loan-originator-training) breaks down everything from deal packaging to lender selection to compliance.
