...
date: 2026-03-10
description: "How to build an SBA lending pipeline from scratch using cold outreach, CPA and attorney referral networks, BizBuySell prospecting, LinkedIn content, conference networking, and inbound strategies."
image: supporting/building-sba-lending-pipeline-hero.webp
category: supporting
author: shane
cluster: originator-training
keywords: ["SBA lending pipeline", "building deal flow", "SBA originator pipeline", "SBA broker prospecting", "SBA cold outreach"]
readingTime: 9
relatedSlugs: ["how-to-become-sba-loan-broker", "you-are-not-urgent-enough", "sba-convention-networking"]
---
...
If you're still figuring out whether SBA origination is the right path, start with our guide on [how to become an SBA loan broker](/how-to-become-sba-loan-broker). But if you already know this is what you want, keep reading. The pipeline doesn't build itself.
