...
**Author:** Brian
**Word Count:** ~1,500
**Keywords:** SBA application checklist, SBA loan documents needed
...
For a deeper understanding of how these documents fit into the [deal structuring process](/sba-deal-structuring-guide), the guide walks through what lenders are actually analyzing in each document.
...
Our [complete guide to SBA 7(a) loans](/complete-guide-sba-7a-loans) covers the acquisition process end-to-end, including how these documents flow through the lender's underwriting.
...
**Send the full package at once.** Partial submissions create multiple review cycles. Wait until you have everything, then submit the complete package. The [SBA loan packaging checklist](/sba-loan-packaging-checklist) can help you track what's still outstanding.
