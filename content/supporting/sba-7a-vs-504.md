...
**Author:** Steph
**Word Count:** ~2,000
**Keywords:** SBA 7a vs 504, SBA loan comparison
...
The 7(a) is the program most borrowers and most lenders default to because of its flexibility. When someone says "SBA loan" without specifying, they almost always mean 7(a). For a deep dive into the program, check out our [complete guide to SBA 7(a) loans](/complete-guide-sba-7a-loans).
...
|---------|----------|---------|
| **Max loan amount** | $5 million | $5.5M (CDC portion) |
| **Use of funds** | Almost anything | Real estate + equipment only |
| **Down payment** | 10-20% | 10% (sometimes 15-20%) |
| **Interest rate** | Variable or fixed | Fixed on CDC portion |
| **Loan structure** | Single loan, single lender | Two loans, two lenders + SBA |
| **Closing complexity** | Standard | More complex (two closings) |
| **Speed** | Faster (one lender decision) | Slower (bank + CDC + SBA approval) |
| **Prepayment penalty** | None after 3 years (on 25-year) | Yes — declining over 10 years on CDC portion |
| **Refinancing eligible** | Yes | Yes (with conditions) |
| **Working capital** | Yes | No |
| **Business acquisition** | Yes | Partial (real estate component only) |
...
For structuring guidance on 7(a) deals, the [deal structuring guide](/sba-deal-structuring-guide) walks through the full process.
...
**The borrower qualifies for [100% financing programs](/100-financing-for-business-expansion).** In some cases, particularly with energy-efficient projects, the 504 offers enhanced terms that can cover a larger portion of the project cost.
...
**Example 1: Restaurant acquisition — $1.2 million**
A borrower wants to buy an existing restaurant (business + lease, no real estate). The purchase price includes $400K in equipment, $300K in goodwill, $200K in inventory, and $300K for working capital.

**Answer: 7(a).** The 504 can't touch goodwill, inventory, or working capital. This is a textbook 7(a) deal.

**Example 2: Manufacturing facility purchase — $4 million**
An established manufacturer wants to buy their currently leased building. No business acquisition — just the real estate. They want rate certainty for budgeting.
...
**Example 3: Dental practice acquisition with real estate — $2.5 million**
A dentist is buying a practice ($1.5M for the business including goodwill) and the building it sits in ($1M). They want to finance everything.
...
The down payment is often the deciding factor between programs. If equity injection is your biggest question, our [SBA down payment guide](/sba-down-payment) covers what counts, what doesn't, and why most lenders ask for more than the SBA minimum.
