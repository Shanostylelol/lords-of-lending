# The Complete SBA Documentation Checklist

**Author:** Brian
**Word Count:** ~1,500
**Keywords:** SBA documentation checklist, SBA forms required
...
If you're still getting comfortable with how to position deals for lenders, the [SBA 7(a) program guide](/complete-guide-sba-7a-loans) explains what underwriters actually evaluate and why.
...
For originators still learning these forms, the [SBA loan packaging checklist](/sba-loan-packaging-checklist) walks through the preparation sequence step by step.
...
Submitting an incomplete package. Every missing item creates a round-trip delay of 2-5 business days while the underwriter sends a request, the originator relays it to the borrower, and the borrower tracks it down. Three missing items can add two to three weeks to your timeline. The [100% financing article](/100-financing-for-business-expansion) shows how even well-structured deals depend on clean documentation to close.
