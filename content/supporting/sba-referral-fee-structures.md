---
title: "SBA Referral Fee Structures: How Brokers Actually Get Paid"
slug: sba-referral-fee-structures
date: 2026-03-10
description: "A straight-talk breakdown of how SBA loan broker fees work — typical fee ranges, who pays, when you collect, fee agreements, compliance requirements, and how to build lender relationships that pay consistently."
image: supporting/sba-referral-fee-structures-hero.webp
category: supporting
author: shane
cluster: originator-training
keywords: ["SBA referral fees", "SBA broker compensation", "SBA broker fees", "SBA loan broker commission", "SBA originator pay"]
readingTime: 9
relatedSlugs: ["how-to-become-sba-loan-broker", "sba-loan-originator-training", "building-sba-lending-pipeline"]
---

# SBA Referral Fee Structures: How Brokers Actually Get Paid
...
|---|---|---|
| Borrower-paid broker fee | 1% - 2% of loan amount | Most common range. Fees above 2% draw scrutiny from lenders and SBA |
| Lender-paid referral fee | 0.5% - 1.5% of loan amount | Varies by lender and deal size. Larger deals often get a lower percentage |
| Flat packaging fee | $2,500 - $10,000 | Some brokers charge a flat fee rather than a percentage, especially on smaller deals |
| Success fee only | 1% - 2% at closing | No upfront payment. Broker takes all the risk — if the deal doesn't close, they don't get paid |
...
5. **State regulations apply.** Many states have additional licensing and fee disclosure requirements for commercial loan brokers. Check your state's financial regulatory authority. We covered this in our guide on [How to Become an SBA Loan Broker](/how-to-become-sba-loan-broker).
...
If you want to go deeper into the tactical side of building a pipeline that feeds these relationships, our guide on [Building an SBA Lending Pipeline](/building-sba-lending-pipeline) covers the CRM, the lead qualification, and the follow-up systems that make it work. And our [SBA Loan Originator Training overview](/sba-loan-originator-training) covers the full skill set you need to build a real career in this space.
