...
| SBA guaranty fee | $22,000 |
| **Total project cost** | **$927,000** |
| **10% equity injection** | **$92,700** |
...
If you want the full breakdown of how equity injection fits into the broader deal structure, our [SBA Deal Structuring Guide](/sba-deal-structuring-guide) covers that end to end.
...
For a deeper look at how seller notes interact with deal structure, [Episode 15: Seller Notes Deep Dive](/seller-notes-deep-dive-lol-15) is the most detailed conversation we've recorded on this topic.
...
If you already own a business and you're acquiring another one — especially in the same industry — the equity in your existing operation can count toward your injection. This is particularly relevant for same-industry expansions where the SBA may reduce or even waive the equity injection requirement entirely. Our guide on [100% Financing for Business Expansion](/100-financing-for-business-expansion) covers that scenario in detail.
...
If you're early in the process and still figuring out whether you're truly ready to buy, our [readiness assessment guide](/are-you-ready-to-buy-a-business) will help you evaluate your financial and operational foundation before you commit to a deal.
...
- **[IRS: Rollovers as Business Start-Ups (ROBS)](https://www.irs.gov/retirement-plans/rollovers-as-business-start-ups-compliance-project)** — The official IRS page explaining ROBS arrangements, compliance requirements, and common pitfalls. Required reading before using retirement funds
- **[SBA Loan Programs Overview](https://www.sba.gov/funding-programs/loans)** — Covers all SBA-backed loan options, including how equity injection fits into the overall financing structure
- **[SBA Startup Costs Calculator](https://www.sba.gov/business-guide/plan-your-business/calculate-your-startup-costs)** — Free worksheet to help you calculate total project cost, which is the number your equity injection is based on
